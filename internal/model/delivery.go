...
type Delivery struct {
	...
	Stage          string  `gorm:"column:stage;size:20;default:upload_pending;comment:阶段 upload_pending-待上传样片 selecting-客户选片中 retouching-精修进行中 deliver_ready-待确认交付 completed-已交付" json:"stage"`
